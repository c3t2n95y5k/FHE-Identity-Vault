...
const FHEVMExecutor_itf_js_1 = require("../contracts/FHEVMExecutor.itf.js");
...
class MockCoprocessor {
    ...
    async computeCoprocessorSignatures(handlesBytes32List, contractChainId, contractAddress, userAddress) {
        ...
        const eip712 = __classPrivateFieldGet(this, _MockCoprocessor_inputVerifier, "f").createCiphertextVerificationEIP712(handlesBytes32HexList, contractChainId, contractAddress, userAddress);
