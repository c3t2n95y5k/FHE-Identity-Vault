...
class MockFhevmInstance {
    ...
    createEIP712(publicKey, contractAddresses, startTimestamp, durationDays) {
        ...
        (0, error_js_1.assertFhevm)(__classPrivateFieldGet(this, _MockFhevmInstance_kmsVerifier, "f").eip712Domain.chainId === BigInt(__classPrivateFieldGet(this, _MockFhevmInstance_gatewayChainId, "f")));
        return eip712;
    }
    ...
    async publicDecrypt(handles) {
        ...
        const relayerHandles = handles.map((h) => typeof h === "string" ? (0, hex_js_1.toHexString)((0, hex_js_1.fromHexString)(h), true) : (0, hex_js_1.toHexString)(h, true));
        ...
        const recoveredAddresses = signatures.map((signature) => {
            ...
            const recoveredAddress = ethers_1.ethers.verifyTypedData(domain, types, { ctHandles: handles, decryptedResult }, sig);
    ...
    async userDecrypt(handles, _privateKey, publicKey, signature, contractAddresses, userAddress, startTimestamp, durationDays) {
        ...
        const clearTextHexList = await relayer.requestRelayerV1UserDecrypt(__classPrivateFieldGet(this, _MockFhevmInstance_relayerProvider, "f"), payloadForRequest);
    ...
    static async verifySignature(publicKey, signature, contractAddresses, userAddress, startTimestamp, durationDays, verifyingContractAddressDecryption, contractsChainId) {
    ...
    async _verifySignature(publicKey, signature, contractAddresses, userAddress, startTimestamp, durationDays) {
        await MockFhevmInstance.verifySignature(publicKey, signature, contractAddresses, userAddress, startTimestamp, durationDays, __classPrivateFieldGet(this, _MockFhevmInstance_verifyingContractAddressDecryption, "f"), __classPrivateFieldGet(this, _MockFhevmInstance_contractsChainId, "f"));
    }
