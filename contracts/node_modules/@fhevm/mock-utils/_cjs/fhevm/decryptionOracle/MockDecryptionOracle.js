...
class MockDecryptionOracle {
    ...
    async createDecryptionSignatures(handlesBytes32Hex, clearTextValues) {
        ...
        const res = await (0, KMSVerifier_js_1.computeDecryptionSignatures)(handlesBytes32Hex, clearTextValues, ethers_1.ethers.AbiCoder.defaultAbiCoder(), __classPrivateFieldGet(this, _MockDecryptionOracle_kmsVerifier, "f"), __classPrivateFieldGet(this, _MockDecryptionOracle_kmsSigners, "f"));
