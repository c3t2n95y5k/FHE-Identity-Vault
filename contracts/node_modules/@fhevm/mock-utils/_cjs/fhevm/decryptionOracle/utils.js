...
async function getDecryptionOracleAddress(provider, contractAddress) {
    const decryptionRequestsStorageLocation = (0, storage_js_1.computeStorageLocation)("fhevm.storage.DecryptionRequests");
    (0, error_js_1.assertFhevm)(decryptionRequestsStorageLocation === "0x5ea69329017273582817d320489fbd94f775580e90c092699ca6f3d12fdf7d00");
    const addresses = await (0, storage_js_1.getAddressesFromStorage)(provider, contractAddress, decryptionRequestsStorageLocation, 1);
    return addresses[0];
}
