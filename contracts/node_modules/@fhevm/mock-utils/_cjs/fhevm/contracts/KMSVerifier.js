...
class KMSVerifier extends FhevmContractWrapper_js_1.FhevmCoprocessorContractWrapper {
    ...
    async _initialize() {
        ...
        (0, error_js_1.assertFhevm)(constants_js_1.default.DECRYPTION_EIP712_DOMAIN.name === __classPrivateFieldGet(this, _KMSVerifier_eip712Domain, "f").name);
        (0, error_js_1.assertFhevm)(constants_js_1.default.DECRYPTION_EIP712_DOMAIN.version === __classPrivateFieldGet(this, _KMSVerifier_eip712Domain, "f").version);
    }
    get address() {
    ...
    createPublicDecryptVerificationEIP712(handlesBytes32List, decryptedResult) {
        const eip712 = {
            domain: {
            ...
            types: constants_js_1.default.PUBLIC_DECRYPT_EIP712_TYPE,
            message: {
...
async function computeDecryptionSignatures(handlesBytes32Hex, clearTextValues, abiCoder, kmsVerifier, kmsSigners) {
...
async function computeDecryptionCallbackSignaturesAndCalldata(handlesBytes32Hex, clearTextValuesString, requestID, callbackSelectorBytes4Hex, abiCoder, kmsVerifier, kmsSigners) {
    const { signatures, types, values } = await computeDecryptionSignatures(handlesBytes32Hex, clearTextValuesString, abiCoder, kmsVerifier, kmsSigners);
