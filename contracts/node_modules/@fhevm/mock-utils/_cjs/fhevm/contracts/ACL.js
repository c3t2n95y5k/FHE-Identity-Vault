...
const ACL_itf_js_1 = require("./ACL.itf.js");
const FhevmContractWrapper_js_1 = require("./FhevmContractWrapper.js");
class ACL extends FhevmContractWrapper_js_1.FhevmCoprocessorContractWrapper {
    constructor() {
        super("ACL");
    ...
    static async create(runner, aclContractAddress, abi, properties) {
        ...
        __classPrivateFieldSet(acl, _ACL_aclReadOnlyContract, new ethers_1.ethers.Contract(aclContractAddress, abi ?? ACL_itf_js_1.ACLPartialInterface, runner), "f");
    ...
    get readonlyContract() {
        (0, error_js_1.assertFhevm)(__classPrivateFieldGet(this, _ACL_aclReadOnlyContract, "f") !== undefined, `ACL wrapper is not yet initialized`);
    ...
    get address() {
        (0, error_js_1.assertFhevm)(__classPrivateFieldGet(this, _ACL_aclContractAddress, "f") !== undefined, `ACL wrapper is not yet initialized`);
