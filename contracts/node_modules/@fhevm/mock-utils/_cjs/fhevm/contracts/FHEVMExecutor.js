...
exports.FHEVMExecutor = void 0;
const ethers_1 = require("ethers");
const address_js_1 = require("../../utils/address.js");
const error_js_1 = require("../../utils/error.js");
const string_js_1 = require("../../utils/string.js");
const FHEVMExecutor_itf_js_1 = require("./FHEVMExecutor.itf.js");
const FhevmContractWrapper_js_1 = require("./FhevmContractWrapper.js");
class FHEVMExecutor extends FhevmContractWrapper_js_1.FhevmCoprocessorContractWrapper {
    constructor() {
        super("FHEVMExecutor");
    ...
    static async create(runner, fhevmExecutorContractAddress, abi, properties) {
        (0, address_js_1.assertIsAddress)(fhevmExecutorContractAddress, "fhevmExecutorContractAddress");
        ...
        __classPrivateFieldSet(fhevmExecutor, _FHEVMExecutor_fhevmExecutorReadonlyContract, new ethers_1.ethers.Contract(fhevmExecutorContractAddress, abi ?? FHEVMExecutor_itf_js_1.FHEVMExecutorPartialInterface, runner), "f");
    ...
    get readonlyContract() {
        (0, error_js_1.assertFhevm)(__classPrivateFieldGet(this, _FHEVMExecutor_fhevmExecutorReadonlyContract, "f") !== undefined, `FHEVMExecutor wrapper is not yet initialized`);
    ...
    get address() {
        (0, error_js_1.assertFhevm)(__classPrivateFieldGet(this, _FHEVMExecutor_fhevmExecutorContractAddress, "f") !== undefined, `FHEVMExecutor wrapper is not yet initialized`);
        return __classPrivateFieldGet(this, _FHEVMExecutor_fhevmExecutorContractAddress, "f");
    }
    get version() {
        (0, error_js_1.assertFhevm)(__classPrivateFieldGet(this, _FHEVMExecutor_version, "f") !== undefined, `FHEVMExecutor wrapper is not yet initialized`);
        return __classPrivateFieldGet(this, _FHEVMExecutor_version, "f");
    }
    get aclAddress() {
        (0, error_js_1.assertFhevm)(__classPrivateFieldGet(this, _FHEVMExecutor_aclAddress, "f") !== undefined, `FHEVMExecutor wrapper is not yet initialized`);
        return __classPrivateFieldGet(this, _FHEVMExecutor_aclAddress, "f");
    }
    get hcuLimitAddress() {
        (0, error_js_1.assertFhevm)(__classPrivateFieldGet(this, _FHEVMExecutor_hcuLimitAddress, "f") !== undefined, `FHEVMExecutor wrapper is not yet initialized`);
        return __classPrivateFieldGet(this, _FHEVMExecutor_hcuLimitAddress, "f");
    }
    get inputVerifierAddress() {
        (0, error_js_1.assertFhevm)(__classPrivateFieldGet(this, _FHEVMExecutor_inputVerifierAddress, "f") !== undefined, `FHEVMExecutor wrapper is not yet initialized`);
        return __classPrivateFieldGet(this, _FHEVMExecutor_inputVerifierAddress, "f");
    }
    async _initialize() {
        (0, error_js_1.assertFhevm)(__classPrivateFieldGet(this, _FHEVMExecutor_fhevmExecutorReadonlyContract, "f") !== undefined, `FHEVMExecutor wrapper is not initialized`);
        ...
        (0, address_js_1.assertIsAddress)(__classPrivateFieldGet(this, _FHEVMExecutor_aclAddress, "f"), "aclAddress");
        ...
        (0, address_js_1.assertIsAddress)(__classPrivateFieldGet(this, _FHEVMExecutor_hcuLimitAddress, "f"), "hcuLimitAddress");
        ...
        (0, address_js_1.assertIsAddress)(__classPrivateFieldGet(this, _FHEVMExecutor_inputVerifierAddress, "f"), "inputVerifierAddress");
        ...
        (0, string_js_1.assertIsString)(__classPrivateFieldGet(this, _FHEVMExecutor_version, "f"), "version");
    }
}
exports.FHEVMExecutor = FHEVMExecutor;
_FHEVMExecutor_fhevmExecutorReadonlyContract = new WeakMap(), _FHEVMExecutor_fhevmExecutorContractAddress = new WeakMap(), _FHEVMExecutor_aclAddress = new WeakMap(), _FHEVMExecutor_hcuLimitAddress = new WeakMap(), _FHEVMExecutor_inputVerifierAddress = new WeakMap(), _FHEVMExecutor_version = new WeakMap();
