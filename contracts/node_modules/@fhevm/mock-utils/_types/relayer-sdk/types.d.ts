...
export interface FhevmSdkModule {
    createEIP712: (gatewayChainId: number, verifyingContract: string, contractsChainId: number) => (publicKey: string | Uint8Array, contractAddresses: string[], startTimestamp: string | number, durationDays: string | number, delegatedAccount?: string) => EIP712;
    generateKeypair: () => {
        publicKey: string;
        privateKey: string;
    };
}
export type { DecryptedResults, EncryptionTypes, PublicParams, RelayerEncryptedInput, EncryptedInput, FhevmInstanceConfig, EIP712Type, EIP712, HandleContractPair, HandleContractPairRelayer, FhevmInstance, };
