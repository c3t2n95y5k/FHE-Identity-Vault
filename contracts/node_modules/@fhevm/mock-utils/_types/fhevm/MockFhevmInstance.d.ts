...
export declare class MockFhevmInstance implements FhevmInstance {
    ...
    static verifySignature(publicKey: string, signature: string, contractAddresses: string[], userAddress: string, startTimestamp: string | number, durationDays: string | number, verifyingContractAddressDecryption: string, contractsChainId: number): Promise<void>;
