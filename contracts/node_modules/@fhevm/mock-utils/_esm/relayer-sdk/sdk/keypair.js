 ...
 */
export const createEIP712 = (verifyingContract, contractsChainId) => (publicKey, contractAddresses, startTimestamp, durationDays, delegatedAccount) => {
    if (delegatedAccount && !EthersT.isAddress(delegatedAccount))
        throw new FhevmError("Invalid delegated account.");
