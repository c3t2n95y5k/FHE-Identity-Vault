...
export function checkDeadlineValidity(startTimestamp, durationDays) {
...
export function buildUserDecryptedResult(handles, listBigIntDecryptions) {
    let typesList = [];
...
export function checkMaxContractAddresses(contractAddresses) {
