...
export class MockFhevmInstance {
    ...
    createEIP712(publicKey, contractAddresses, startTimestamp, durationDays) {
        ...
        assertFhevm(__classPrivateFieldGet(this, _MockFhevmInstance_kmsVerifier, "f").eip712Domain.chainId === BigInt(__classPrivateFieldGet(this, _MockFhevmInstance_gatewayChainId, "f")));
        return eip712;
    }
    ...
    async publicDecrypt(handles) {
        ...
        const relayerHandles = handles.map((h) => typeof h === "string" ? toHexString(fromHexString(h), true) : toHexString(h, true));
        // relayer-sdk
