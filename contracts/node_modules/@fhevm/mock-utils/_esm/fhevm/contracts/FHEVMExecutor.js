...
export class FHEVMExecutor extends FhevmCoprocessorContractWrapper {
    ...
    static async create(runner, fhevmExecutorContractAddress, abi, properties) {
        ...
        __classPrivateFieldSet(fhevmExecutor, _FHEVMExecutor_fhevmExecutorReadonlyContract, new EthersT.Contract(fhevmExecutorContractAddress, abi ?? FHEVMExecutorPartialInterface, runner), "f");
    ...
    get readonlyContract() {
        assertFhevm(__classPrivateFieldGet(this, _FHEVMExecutor_fhevmExecutorReadonlyContract, "f") !== undefined, `FHEVMExecutor wrapper is not yet initialized`);
    ...
    get address() {
        assertFhevm(__classPrivateFieldGet(this, _FHEVMExecutor_fhevmExecutorContractAddress, "f") !== undefined, `FHEVMExecutor wrapper is not yet initialized`);
    ...
    get hcuLimitAddress() {
        assertFhevm(__classPrivateFieldGet(this, _FHEVMExecutor_hcuLimitAddress, "f") !== undefined, `FHEVMExecutor wrapper is not yet initialized`);
    ...
    async _initialize() {
        assertFhevm(__classPrivateFieldGet(this, _FHEVMExecutor_fhevmExecutorReadonlyContract, "f") !== undefined, `FHEVMExecutor wrapper is not initialized`);
        ...
        assertIsAddress(__classPrivateFieldGet(this, _FHEVMExecutor_hcuLimitAddress, "f"), "hcuLimitAddress");
