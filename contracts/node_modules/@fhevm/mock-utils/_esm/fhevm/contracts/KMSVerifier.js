...
export class KMSVerifier extends FhevmCoprocessorContractWrapper {
    ...
    async _initialize() {
        ...
        assertFhevm(constants.DECRYPTION_EIP712_DOMAIN.name === __classPrivateFieldGet(this, _KMSVerifier_eip712Domain, "f").name);
        assertFhevm(constants.DECRYPTION_EIP712_DOMAIN.version === __classPrivateFieldGet(this, _KMSVerifier_eip712Domain, "f").version);
    }
    get address() {
...
export async function computeDecryptionSignatures(handlesBytes32Hex, clearTextValues, abiCoder, kmsVerifier, kmsSigners) {
...
export async function computeDecryptionCallbackSignaturesAndCalldata(handlesBytes32Hex, clearTextValuesString, requestID, callbackSelectorBytes4Hex, abiCoder, kmsVerifier, kmsSigners) {
