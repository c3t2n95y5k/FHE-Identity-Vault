...
import { BlockLogCursor, assertEventArgIsAddress, assertEventArgIsBigUint256, assertEventArgIsBytes4String, assertEventArgIsBytes32String, } from "../../ethers/event.js";
...
export async function getDecryptionOracleEvents(decryptionOracleContractInterface, decryptionOracleContractAddress, readonlyProvider, options) {
...
export function toDecryptionRequestEvent(e) {
...
export function parseDecryptionRequestEventsFromLogs(logs) {
    // flexible
    if (!logs) {
        return [];
    }
 ...
 */
export async function getDecryptionOracleAddress(provider, contractAddress) {
    const decryptionRequestsStorageLocation = computeStorageLocation("fhevm.storage.DecryptionRequests");
    assertFhevm(decryptionRequestsStorageLocation === "0x5ea69329017273582817d320489fbd94f775580e90c092699ca6f3d12fdf7d00");
    /*
    ...
    */
    const addresses = await getAddressesFromStorage(provider, contractAddress, decryptionRequestsStorageLocation, 1 /* number of addresses in the struct */);
    return addresses[0];
}
