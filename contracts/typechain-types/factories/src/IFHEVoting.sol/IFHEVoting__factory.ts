...
import type {
  IFHEVoting,
  IFHEVotingInterface,
} from "../../../src/IFHEVoting.sol/IFHEVoting";
...
export class IFHEVoting__factory {
  static readonly abi = _abi;
  static createInterface(): IFHEVotingInterface {
    return new Interface(_abi) as IFHEVotingInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IFHEVoting {
    return new Contract(address, _abi, runner) as unknown as IFHEVoting;
  }
}
