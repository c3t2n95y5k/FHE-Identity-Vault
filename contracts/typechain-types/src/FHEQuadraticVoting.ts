...
export declare namespace IFHEQuadraticVoting {
  export type QuadraticVoteAllocationStruct = {
    encryptedCredits: BytesLike;
    encryptedAllocations: BytesLike[];
    totalCreditsUsed: BigNumberish;
  };

  export type QuadraticVoteAllocationStructOutput = [
    encryptedCredits: string,
    encryptedAllocations: string[],
...
export interface FHEQuadraticVotingInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_CREDITS"
      | "MAX_OPTIONS"
  ...
  encodeFunctionData(
    functionFragment: "defaultCredits",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getQuadraticTotals",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "getQuadraticVotingStats",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getVoteAllocation",
  ...
  encodeFunctionData(
    functionFragment: "getVotingPowerDistribution",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "optionQuadraticTotals",
    values: [BigNumberish, BigNumberish]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "refundUnusedCredits",
    values: [BigNumberish, AddressLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setDefaultCredits",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "verifyQuadraticAllocation",
    values: [BigNumberish, AddressLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "voteAllocations",
    values: [BigNumberish, AddressLike]
  ): string;
  encodeFunctionData(
    functionFragment: "voterCredits",
    values: [BigNumberish, AddressLike]
  ): string;
  encodeFunctionData(
...
export namespace CreditsRefundedEvent {
  export type InputTuple = [
    votingId: BigNumberish,
    voter: AddressLike,
    creditsRefunded: BigNumberish
  ];
  export type OutputTuple = [
    votingId: bigint,
    voter: string,
    creditsRefunded: bigint
  ];
  export interface OutputObject {
    votingId: bigint;
    voter: string;
...
export namespace QuadraticVoteAllocatedEvent {
  export type InputTuple = [
    votingId: BigNumberish,
    voter: AddressLike,
    creditsUsed: BigNumberish,
...
export interface FHEQuadraticVoting extends BaseContract {
  connect(runner?: ContractRunner | null): FHEQuadraticVoting;
  waitForDeployment(): Promise<this>;

  interface: FHEQuadraticVotingInterface;
  ...
  MAX_CREDITS: TypedContractMethod<[], [bigint], "view">;
  ...
  MIN_CREDITS: TypedContractMethod<[], [bigint], "view">;
  ...
  defaultCredits: TypedContractMethod<[arg0: BigNumberish], [bigint], "view">;
  ...
  getQuadraticTotals: TypedContractMethod<
    [votingId: BigNumberish],
    [string[]],
    "view"
  >;

  getQuadraticVotingStats: TypedContractMethod<
    [votingId: BigNumberish],
    [
      [bigint, bigint, bigint] & {
        totalCreditsAllocated: bigint;
        totalCreditsUsed: bigint;
        averageCreditsPerVoter: bigint;
      }
    ],
    "view"
  >;
  ...
  getVoteAllocation: TypedContractMethod<
    [votingId: BigNumberish, voter: AddressLike],
    [IFHEQuadraticVoting.QuadraticVoteAllocationStructOutput],
    "view"
  >;
  ...
  getVotingPowerDistribution: TypedContractMethod<
    [votingId: BigNumberish],
    [bigint[]],
    "view"
  >;
  ...
  optionQuadraticTotals: TypedContractMethod<
    [arg0: BigNumberish, arg1: BigNumberish],
    [string],
    "view"
  >;
  ...
  refundUnusedCredits: TypedContractMethod<
    [votingId: BigNumberish, voter: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  setDefaultCredits: TypedContractMethod<
    [votingId: BigNumberish, credits: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  verifyQuadraticAllocation: TypedContractMethod<
    [votingId: BigNumberish, voter: AddressLike],
    [boolean],
    "view"
  >;
  ...
  voteAllocations: TypedContractMethod<
    [arg0: BigNumberish, arg1: AddressLike],
    [[string, bigint] & { encryptedCredits: string; totalCreditsUsed: bigint }],
    "view"
  >;

  voterCredits: TypedContractMethod<
    [arg0: BigNumberish, arg1: AddressLike],
    [bigint],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "defaultCredits"
  ): TypedContractMethod<[arg0: BigNumberish], [bigint], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "getQuadraticTotals"
  ): TypedContractMethod<[votingId: BigNumberish], [string[]], "view">;
  getFunction(
    nameOrSignature: "getQuadraticVotingStats"
  ): TypedContractMethod<
    [votingId: BigNumberish],
    [
      [bigint, bigint, bigint] & {
  ...
  getFunction(
    nameOrSignature: "getVoteAllocation"
  ): TypedContractMethod<
    [votingId: BigNumberish, voter: AddressLike],
    [IFHEQuadraticVoting.QuadraticVoteAllocationStructOutput],
    "view"
  ...
  getFunction(
    nameOrSignature: "getVotingPowerDistribution"
  ): TypedContractMethod<[votingId: BigNumberish], [bigint[]], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "optionQuadraticTotals"
  ): TypedContractMethod<
    [arg0: BigNumberish, arg1: BigNumberish],
    [string],
    "view"
  ...
  >;
  getFunction(
    nameOrSignature: "refundUnusedCredits"
  ): TypedContractMethod<
    [votingId: BigNumberish, voter: AddressLike],
    [void],
    "nonpayable"
  ...
  getFunction(
    nameOrSignature: "setDefaultCredits"
  ): TypedContractMethod<
    [votingId: BigNumberish, credits: BigNumberish],
    [void],
    "nonpayable"
  ...
  getFunction(
    nameOrSignature: "verifyQuadraticAllocation"
  ): TypedContractMethod<
    [votingId: BigNumberish, voter: AddressLike],
    [boolean],
    "view"
  ...
  >;
  getFunction(
    nameOrSignature: "voteAllocations"
  ): TypedContractMethod<
    [arg0: BigNumberish, arg1: AddressLike],
    [[string, bigint] & { encryptedCredits: string; totalCreditsUsed: bigint }],
    "view"
  ...
  getEvent(
    ...
    CreditsRefundedEvent.InputTuple,
    CreditsRefundedEvent.OutputTuple,
    CreditsRefundedEvent.OutputObject
  >;
  getEvent(
  ...
  >;
  getEvent(
    key: "QuadraticVoteAllocated"
  ): TypedContractEvent<
    QuadraticVoteAllocatedEvent.InputTuple,
    QuadraticVoteAllocatedEvent.OutputTuple,
    QuadraticVoteAllocatedEvent.OutputObject
  >;
  getEvent(
    key: "QuorumReached"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "CreditsRefunded(uint256,address,uint256)": TypedContractEvent<
      CreditsRefundedEvent.InputTuple,
      CreditsRefundedEvent.OutputTuple,
      CreditsRefundedEvent.OutputObject
    >;
    CreditsRefunded: TypedContractEvent<
      CreditsRefundedEvent.InputTuple,
      CreditsRefundedEvent.OutputTuple,
      CreditsRefundedEvent.OutputObject
    >;
    ...
    "QuadraticVoteAllocated(uint256,address,uint256,uint256)": TypedContractEvent<
      QuadraticVoteAllocatedEvent.InputTuple,
      QuadraticVoteAllocatedEvent.OutputTuple,
      QuadraticVoteAllocatedEvent.OutputObject
    >;
    QuadraticVoteAllocated: TypedContractEvent<
      QuadraticVoteAllocatedEvent.InputTuple,
      QuadraticVoteAllocatedEvent.OutputTuple,
      QuadraticVoteAllocatedEvent.OutputObject
    >;
