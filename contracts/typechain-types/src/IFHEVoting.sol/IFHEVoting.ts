...
export interface IFHEVotingInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "castQuadraticVote"
      | "castVote"
...
export interface IFHEVoting extends BaseContract {
  connect(runner?: ContractRunner | null): IFHEVoting;
  waitForDeployment(): Promise<this>;

  interface: IFHEVotingInterface;
